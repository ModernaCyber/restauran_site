...
const MenuHeader: React.FC  = () => {
  return (
    <div className="w-full h-auto min-h-[300px] flex flex-col justify-center items-center mb-24">
      <div className="w-auto p-8">
        <img src={parcelli} alt="" className="" />
      </div>
      <h2 className="font-bold text-4xl my-8">Our Menu</h2>
      <h3 className="font-normal capitalize text-neutral-700 text-xl">
        Quality Ingredients, Tasty meals
      </h3>
      <p className="text-center text-sm text-neutral-500 w-auto max-w-[600px] my-4">
